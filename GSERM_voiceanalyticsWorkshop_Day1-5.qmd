...
- Perform a t-test to check if average pitch (`pitch_mean`) differs significantly between happy and sad speech.
- Fit a logistic regression model in R to predict pitch_mean emotion (`Condition`) from your  acoustic features (e.g., `mean_F0`).
...
![Simple, Vibe-Coded AI Agent Using Google Antigravity](Demo_AgentGemini.png)
